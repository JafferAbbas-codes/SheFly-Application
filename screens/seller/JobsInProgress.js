      ...
      <View style={styles.back}>
        ...
        <MainCard>
          <ScrollView style={styles.container}>
            {console.log(' in scroll view', props.route.params.jobsInProgress)}
            <FlatList
              data={props.route.params.jobsInProgress}
...
export default connect(mapStateToProps)(JobsInProgress);

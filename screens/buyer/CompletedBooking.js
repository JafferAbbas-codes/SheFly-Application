...
const completedBookings = (props) => {
  ...
  console.log('in props completed.b', props);
        ...
        <MainCard>
          <SafeAreaView style={styles.container}>
            {console.log(
              ...
              props.route.params.completedBookings,
            )}
            <FlatList
              data={props.route.params.completedBookings}
...
export default connect(mapStateToProps)(completedBookings);
